...
@Component({
  selector: 'page-armas-melee-martial',
  templateUrl: 'armas-melee-martial.html',
  providers: [DataService]
})
export class ArmasMeleeMartialPage {
  ...
  constructor(public navCtrl: NavController, 
    public navParams: NavParams, public dataServ: DataService) {

  }

  loadArmas(){
    this.dataServ.getMartialMeleeWeapons().then(data =>{
