...
@Component({
  selector: 'page-armas-ranged-martial',
  templateUrl: 'armas-ranged-martial.html'
})
export class ArmasRangedMartialPage {
  ...
  loadArmas(){
    this.dataServ.getMartialRangedWeapons().then(data =>{
